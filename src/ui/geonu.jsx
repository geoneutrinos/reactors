      ...
      <Card.Body>
        <Form.Group controlId="U238flux">
          <Form.Label>
            ...
            {" "}
            <small>(<sup>238</sup>U plus <sup>235</sup>U Heating: <Num v={heating.U238 + heating.U235} p={2} func={(v) => v / 1e12}/> TW)</small>
          </Form.Label>
          <Form.Control
        ...
        <Form.Group controlId="ThURatio">
          <InputGroup>
            ...
            {" "}
            <small>(<sup>232</sup>Th Heating: <Num v={heating.Th232} p={2} func={(v) => v / 1e12}/> TW)</small>
            </Form.Label>
            <Form.Control
        ...
        <Form.Group controlId="KURatio">
          <InputGroup>
            ...
            {" "}
            <small>(<sup>40</sup>K<sub>β</sub> Heating: <Num v={heating.K40Beta} p={2} func={(v) => v / 1e12}/> TW)</small>
            </Form.Label>
            <Form.Control
        ...
        <br /> <small>Assumes homogeneous element concentrations with PREM mantle mass and geophysical response</small> 
      </Card.Body>
    </Card>
  );
};
