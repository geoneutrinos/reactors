...
export class StatsPanel extends React.Component {
    render = () => {
        ...
        return (
            <div>
                <i>R</i><sub>total</sub> = {data.total_tnu.toFixed(1)} TNU<br />
                <i>R</i><sub>reac</sub> = {data.reactors_tnu.toFixed(1)} TNU<br />
                <i>R</i><sub>closest</sub> = {data.closest_tnu.toFixed(1)} TNU ({(data.closest_tnu / data.total_tnu * 100).toFixed(1)} % of total)<br />
                ...
                <span style={{ "display": userDisplay(data.custom_tnu) }}><i>R</i><sub>user</sub> = {data.custom_tnu.toFixed(1)} TNU<br /></span>
                <i>R</i><sub>E &lt; 3.275 MeV</sub> = {data.total_tnu_geo.toFixed(1)} TNU<br />
                <i>R</i><sub>geo</sub> = {data.geo_tnu.toFixed(1)} TNU (U = {data.geo_u_tnu.toFixed(1)}, Th = {data.geo_th_tnu.toFixed(1)})<br />
