  ...
  const layout = {
    ...
    polar: {
      angularaxis: {
        ...
        ticktext: ["0&deg;", "45&deg;", "90&deg;", "135&deg;", "180&deg;", "-135&deg;", "-90&deg;", "-45&deg;"],
      },
    },
    legend: {
      x: 1,
    ...
    annotations: [
      {
        ...
        align: "right",
        text:
          "geoneutrinos.org <br />Angular Axis is ENU Azimuth (deg): East is 0&deg;, North is 90&deg;, etc. <br />Radial Axis is Altitude (deg): Horizon 0&deg;, Nadir -90&deg; ",
        x: 1.1,
        xref: "paper",
        y: -0.075,
        yref: "paper",
