  ...
  const layout = {
    ...
    polar: {
      angularaxis: {
        ...
        ticktext: ["90 &deg;", "45", "0", "315", "270", "225", "180", "135"],
      },
    },
    legend: {
      x: 1,
    ...
    annotations: [
      {
        ...
        align: "right",
        text:
          "geoneutrinos.org<br />Angular Axis: Azimuth (deg): North is 0 deg, East is 90 deg, etc.<br />Radial Axis: Altitude (deg): Horizon 0 deg, Nadir -90 deg",
        x: 1.2,
        xref: "paper",
        y: -0.075,
        yref: "paper",
