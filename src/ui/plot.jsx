...
export function NuSpectrumPlot({ cores, spectrum, detector, reactorLF, xaxisExtra={}, yaxisExtra={}, layoutExtra={}, func=(v) => v}) {
  ...
  const layout = {
    title: `Antineutrino Spectrum: ${
      ...
      1
    )}E, ${detector.elevation.toFixed(0)}m)<br /><sub>(${reactorLF.start.toISOString().slice(0, 7)} thru ${reactorLF.end.toISOString().slice(0, 7)} avg LF ; Osc- NuFit v5.0 ${oscillation.massOrdering})</sub>`,
    showlegend: true,
    legend: {
      x: 1,
      xanchor: "right",
