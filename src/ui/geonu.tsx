  ...
  return (
    <Card>
      ...
      <Card.Body>
        ...
        />
        <small>
          Uses pre-computed (1°x1°) model of the crust fluxes from <sup>238</sup>U, <sup>232</sup>Th, and <sup>40</sup>K. 
          <br />Earth: Kindly provided by W.F. McDonough and described in Y. Huang <i>et al.</i> (2013), <i>A reference Earth model
          for the heat producing elements and associated geoneutrino flux</i>, Geochem., Geophys., Geosyst. 14, 2003-2029.
          <br />Moon: Our work described in Lunar Antineutrinos and Heat: Fluxes from Primordial Radioactivity (unpublished).
        </small>
      </Card.Body>
    </Card>
  );
  ...
  return (
    <Card>
      ...
      <Card.Body>
        ...
        Total Mantle Radiogenic Heating: <Num v={heating.U238 + heating.U235 + heating.Th232 + heating.K40Beta + heating.K40Ec} p={2} func={(v) => v / 1e12}/> TW from homogeneous element concentrations
        ...
        <br /> •<small>Moon: Mantle mass (<Num v={MANTLE_MASS} p={4} func={(v) => v * 1e-24} /> x10<sup>24</sup> kg) and geophysical response (<Num v={MANTLE_GEOPHYSICAL_RESPONSE} p={4} func={(v) => v * 1e-3} /> x10<sup>3</sup> kg cm<sup>-2</sup>)</small>
...
export const GeoNusPane = memo(() => {
  return (
    <Card>
      <Card.Header>Antineutrinos from the Earth and Moon</Card.Header>
      <Card.Body>
        <div>
          <p>
            Antineutrinos from long-lived natural radioactivity within the rocky layers of planetary bodies (i.e. Earth, Moon) are commonly known as geo-neutrinos. 
