...
export const RASwitcher = ({active}) => {
  ...
  const InteractionYield = (
    <div>
      <br />
      <h6>pIBD/eES Yields- <small>10<sup>-43</sup> cm<sup>2</sup> fission<sup>-1</sup></small> </br>
      <small>Kinetic energy range of scattered charged lepton- {crossSection.elasticScatteringTMin.toFixed(2)} &lt; T<sub>e</sub> &lt; {crossSection.elasticScatteringTMax.toFixed(2)} MeV </small>small></h6>
    <Table>
