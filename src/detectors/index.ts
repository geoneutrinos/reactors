...
export const presets: DetecorPreset[] = [
    // Moon
    {name: "Apollo 11", lat:0.67416, lon:23.47314, elevation:0, overburden:0, region:"moon", status:"proposed"},
    //Africa
    ...
    //Antarctica
    {name: "IceCube", lat:-89.99, lon:-63.453, elevation:2835, overburden:2200, region:"Antarctica", status:"operational"},
    //Asia
    ...
    {name: "INO", lat:9.955514, lon: 77.283654, elevation:914, overburden:3000, region:"Asia", status:"construction"},
    ...
    {name: "Jiangmen", lat:22.11827, lon: 112.51867, elevation:-481.25, overburden:2100, region:"Asia", status:"construction"},
    //Jinping- detector height -2400 m, surface height 4000 m, geoid height -29.14 m
    {name: "Jinping", lat:28.15323, lon: 101.7114, elevation:1571, overburden:6720, region:"Asia", status:"construction"},
    ...
    {name: "KM3NeT ORCA", lat:42.80, lon: 6.0333, elevation:-2450, overburden:2450, region:"Mediterranean Sea", status:"construction"},
    //North America
    ...
    {name: "SUPL", lat:-37.07, lon: 142.81, elevation:-812, overburden:2700, region:"Oceania", status:"construction"},
    //Pacific Ocean
