...
export const presets: DetecorPreset[] = [
    ...
    {name: "Nestor", lat:36.63, lon: 21.58, elevation:0, overburden:4000, region:"Mediterranean Sea"},
    {name: "NEMO Test", lat:37.551, lon: 15.384, elevation:0, overburden:2080, region:"Mediterranean Sea"},
    // North America
    ...
    // Pacific Ocean
    {name: "ACO", lat:22.75, lon: -158, elevation:0, overburden:4800, region:"Pacific Ocean"},
    {name: "MARS", lat:36.71, lon: -122.19, elevation:0, overburden:890, region:"Pacific Ocean"},
    // South America
