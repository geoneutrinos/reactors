...
import {CrossSection, XSNamesNormal } from '../physics/neutrino-cross-section'
...
export const defaultBoron8: Boron8 = {
    ...
    updateRate: function(this: Boron8, crossSection:CrossSection){
        ...
        newBoron8.boron8Rate =  boron8.map(([bin, spec]) => crossSection[XSNamesNormal.ESNORMAL](bin) * spec * this.boron8Flux);
