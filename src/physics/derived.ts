...
export const ELEMENTAL_NEUTRINO_LUMINOSITY = {
  K: 
    (ISOTOPIC_NATURAL_ABUNDANCE.K40 * (ISOTOPIC_NEUTRINO_LUMINOSITY.K40beta + ISOTOPIC_NEUTRINO_LUMINOSITY.K40ec)) * 1e-2,
  TH:
    (ISOTOPIC_NATURAL_ABUNDANCE.TH232 * ISOTOPIC_NEUTRINO_LUMINOSITY.TH232) * 1e-2,
  U:
    ((ISOTOPIC_NATURAL_ABUNDANCE.U235 * ISOTOPIC_NEUTRINO_LUMINOSITY.U235) + (ISOTOPIC_NATURAL_ABUNDANCE.U238 * ISOTOPIC_NEUTRINO_LUMINOSITY.U238)) * 1e-2,
};
