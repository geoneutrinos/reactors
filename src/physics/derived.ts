...
export const ISOTOPIC_DECAY_ENERGIES = {
  // MeV
  K40:
    (K40.relative_atomic_mass - Ca40.relative_atomic_mass) - ISOTOPIC_ALPHAS_PER_DECAY.K40 * (ALPHA_REST_MASS + 2 * ELECTRON_REST_MASS),
  TH232:
    (Th232.relative_atomic_mass - Pb208.relative_atomic_mass) - ISOTOPIC_ALPHAS_PER_DECAY.Th232 * (ALPHA_REST_MASS + 2 * ELECTRON_REST_MASS),
  U235:
    (U235.relative_atomic_mass - Pb207.relative_atomic_mass) - ISOTOPIC_ALPHAS_PER_DECAY.U235 * (ALPHA_REST_MASS + 2 * ELECTRON_REST_MASS),
  U238:
    (U238.relative_atomic_mass - Pb206.relative_atomic_mass) - ISOTOPIC_ALPHAS_PER_DECAY.U238 * (ALPHA_REST_MASS + 2 * ELECTRON_REST_MASS),
};
