...
export const ELEMENTAL_DECAY_HEATING = {
  // J kg-1 s-1
  K:
    ISOTOPIC_NATURAL_ABUNDANCE.K40 * (K40_BRANCH_RATIO.beta * ISOTOPIC_DECAY_HEATING.K40beta + K40_BRANCH_RATIO.ec * ISOTOPIC_DECAY_HEATING.K40ec),
  TH:
    ISOTOPIC_NATURAL_ABUNDANCE.TH232 * ISOTOPIC_DECAY_HEATING.TH232,
  U:
    ISOTOPIC_NATURAL_ABUNDANCE.U235 * ISOTOPIC_DECAY_HEATING.U235 + ISOTOPIC_NATURAL_ABUNDANCE.U238 * ISOTOPIC_DECAY_HEATING.U238,
};
